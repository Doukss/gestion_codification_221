export class AdminController {
  ...
  async getDashboardStatsAgents() {
    try {
      const rawStats = await this.service.getAllAgents();
  ...
  async getDashboardStatsEtudiants() {
    try {
      const rawStats = await this.service.getAllEtudiants();
      return rawStats.length;
    } catch (error) {
      console.error("AdminController > getDashboardStats failed:", error);
      throw error;
  ...
  async getDashboardStatsChambres() {
    try {
      const rawStats = await this.service.getAllChambres();
      return rawStats.length;
    } catch (error) {
      console.error("AdminController > getDashboardStats failed:", error);
      throw error;

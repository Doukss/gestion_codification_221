...
export class AuthView extends AbstractView {
  ...
  async render() {
    ...
    this.container.innerHTML = `
      ...
      <i class="ri-code-s-slash-fill  text-[#06b6f1] text-xl"></i>
        <p class="text-[#184656] font-medium">E221</p>
      </div>
        ...
        <p class="text-gray-600 text-sm font-medium w-full md:w-96 mb-5">
          Bienvenue sur la plateforme de <span class=" text-[#06b6f1]">GESTION_CODIFICATION</span> ! Connectez-vous pour
        ...
        <button
          type="submit"
          id="loginButton"
          class="w-full h-12 bg-gradient-to-tl from-[#06b6f1] to-[#143b48] text-white rounded font-medium"
        >

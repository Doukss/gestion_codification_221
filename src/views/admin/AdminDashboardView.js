  ...
  getWelcomeTemplate() {
    return `
      ...
      <p class="text-gray-600 dark:text-gray-300">
        Gestion des administrateurs et statistiques
      </p>
    `;
  }

  async renderStatsCards() {
    const statsAgent = await this.controller.getDashboardStatsAgents();
    const statsEtudiant = await this.controller.getDashboardStatsEtudiants();
    const statsChambres = await this.controller.getDashboardStatsChambres();
